// From https://github.com/clavijojuan/L.cascadeButtons/blob/158cc8e315183c50d140e11e209f7dd4f3317850/src/L.cascadeButtons.js
...
L.Control.cascadeButtons = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    this._buttons.forEach((button) => {
      const directionClass = this.buildDirection(
        this.getOposite(this.options.direction),
      );
      ...
      mainButton.setAttribute(
        "title",
        button.title !== undefined ? button.title : "",
      );
    ...
    if (direction === "vertical") {
      if (this.options.position.includes("left")) {
        if (this.options.position.includes("bottom"))
          direction = direction + " col-reverse";
      }
